...
class CustomStringTest {
	...
	public void setUp() throws Exception {
		...
		this.myCustomString = new CustomString(null, false);
	}
	...
	void testGetString() {
		...
		assertEquals("abc", this.myCustomString.getString());
		this.myCustomString.setString("123");
		assertEquals("123", this.myCustomString.getString());
		this.myCustomString.setString("fdg");
		assertEquals("fdg", this.myCustomString.getString());
	}
	...
	void testSetString() {
		...
		this.myCustomString.setString("123");
		assertEquals("123", this.myCustomString.getString());
		this.myCustomString.setString("AAA");
		assertEquals("AAA", this.myCustomString.getString());
	}
	...
	void testRemove() {
		...
		// TODO write at least 3 additional test cases 
		assertEquals("my lucky numbers are 6, 8, and 19.", this.myCustomString.remove("19"));
		assertEquals(" luck nubers are 6, 8, and 19.", this.myCustomString.remove("my"));
		assertEquals("my lucky umbers re 6, 8,  19.", this.myCustomString.remove("and"));
	}
	...
	void testReverse() {
		...
		this.myCustomString.setString("ABCD1234ABCD");
		assertEquals("abCD1234abCD", this.myCustomString.reverse("ab"));
